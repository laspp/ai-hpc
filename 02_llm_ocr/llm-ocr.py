...
# Parse the page range specification (e.g. "1-3,5") into a list of 0-indexed page numbers.
...
# Run OCR on a batch of images with the specified prompt and return the recognized text.
def ocr_images(processor, model, images, prompt, max_new_tokens):
    ...
    # repetition_penalty guard against greedy decoding
    ...
    # Strip the prompt tokens from the output to get only the new tokens generated by the model.
...
def main():
    ...
    # Render the selected pages to images
    ...
    # Run OCR on the images and write the results to the output file
